...
enum cardColors{BLACK, RED};    //牌颜色种类
enum pips{ACE,TWO,THREE,FOUR,FIVE,SIX,SEVEN,EIGHT,NINE,TEN,JACK,QUEEN,KING,SUIT_SIZE};  //牌面值
enum suits{CLUBS,DIAMONDS,HEARTS,SPADES};   //牌花色
